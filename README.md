...
Sample repository showing a simple use case for parsing an Apache Parquet format file using the Go library [parquet-go](https://github.com/fraugster/parquet-go)
